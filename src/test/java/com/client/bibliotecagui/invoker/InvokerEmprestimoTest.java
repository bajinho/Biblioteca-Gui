...
public class InvokerEmprestimoTest {
    ...
    public InvokerEmprestimoTest() throws NamingException {
        this.lookup = context.lookup("ejb:/biblioteca-1.0-SNAPSHOT/EmprestimoBean!"
    ...
    public void testInvokeEmprestimoStatelessBean() {
        ...
        EmprestimoRemote expResult = (EmprestimoRemote) lookup;
